...
def main():
  ...
  parser.add_argument(
      ...
      type=str,
      default="",
      help=(f"The save path of the output state dict "
  ...
  if args.ckpt_type == "model":
    ...
    consolidate_and_reshard_model_dict(args.ckpt_dir, args.ckpt_name, args.reshard_num,
                                          args.save_path)
  else:
    if args.ckpt_name == "":
        args.ckpt_name = OPTIM_NAME_PATTERN
    consolidate_and_reshard_optim_dict(args.ckpt_dir, args.ckpt_name, args.reshard_num,
                                              args.save_path)
